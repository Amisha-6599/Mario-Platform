let config = {
    ...
    // this is used to provide gravity and various laws of motion in the game
    physics:{
        default:'arcade',
        arcade :{
            gravity:{
...
function create(){
    ...
    //add tilesprites[to make a platform by repeating the one image]
    ...
    //we use .depth to avoid overlaping [in this case the background image will come behind the platform]
    background.depth = -2;
...
// hides the game object[apple from the screen] to show that the apple is eaten
